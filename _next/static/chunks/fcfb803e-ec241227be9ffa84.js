...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [666],
  {
    6407: (f, a, e) => {
      ...
      var k = (0, v._)("epr", null);
      n.hidden, n.hiddenOnSearch;
      var y = {};
      setTimeout(function () {
        T.reduce(function (f, a) {
          var e;
          return (
            x((e = a))
              .flat()
      ...
      var j = (0, w.createContext)({
        activeCategoryState: [null, function () {}],
        activeSkinTone: [c.NEUTRAL, function () {}],
      ...
      o.SUGGESTED,
        ...
        o.FLAGS,
        o.SUGGESTED,
        ((r = {})[o.SUGGESTED] = { category: o.SUGGESTED, name: "Frequently Used" }),
        (r[o.CUSTOM] = { category: o.CUSTOM, name: "Custom Emojis" }),
        (r[o.SMILEYS_PEOPLE] = { category: o.SMILEYS_PEOPLE, name: "Smileys & People" }),
        (r[o.ANIMALS_NATURE] = { category: o.ANIMALS_NATURE, name: "Animals & Nature" }),
        (r[o.FOOD_DRINK] = { category: o.FOOD_DRINK, name: "Food & Drink" }),
        (r[o.TRAVEL_PLACES] = { category: o.TRAVEL_PLACES, name: "Travel & Places" }),
        (r[o.ACTIVITIES] = { category: o.ACTIVITIES, name: "Activities" }),
        (r[o.OBJECTS] = { category: o.OBJECTS, name: "Objects" }),
        (r[o.SYMBOLS] = { category: o.SYMBOLS, name: "Symbols" }),
        (r[o.FLAGS] = { category: o.FLAGS, name: "Flags" });
      var E = [c.NEUTRAL, c.LIGHT, c.MEDIUM_LIGHT, c.MEDIUM, c.MEDIUM_DARK, c.DARK].reduce(
        function (f, a) {
          var e;
          return Object.assign(f, (((e = {})[a] = a), e));
        },
        {},
      );
      function x(f) {
        var a;
        return null != (a = f[t.name]) ? a : [];
      }
      function z(f, a) {
        var e,
          n,
      ...
      function S(f) {
        var a;
        return null != (a = f[t.variations]) ? a : [];
      }
      function q(f) {
        return S(f).length > 0;
      }
      var T = Object.values({
          ...
          smileys_people: [
            ...
            { n: ["family adult child", "family: adult, child"], u: "1f9d1-200d-1f9d2", a: "15.1" },
            {
          ...
          flags: [
            ...
            { n: ["flag-tr", "t\xfcrkiye flag"], u: "1f1f9-1f1f7", a: "2.0" },
      ...
      setTimeout(function () {
        ...
        n.emoji,
        n.emoji,
        n.emojiHasVariations;
      var L = k.create({
        external: { ".": n.external, fontSize: "0" },
      ...
      function I(f) {
        var a = f.emojiName,
          ...
          u = f.onError,
          i = f.className;
        return (0, w.createElement)("img", {
          src: d,
          alt: a,
          className: (0, v.cx)(O.emojiImag, L.external, L.common, i),
          loading: void 0 !== n && n ? "lazy" : "eager",
          onError: u,
          style: e,
        });
      }
      ...
      function U(f) {
        ...
        return (0, w.createElement)(
          "span",
          {
            className: (0, v.cx)(C.nativeEmoji, L.common, L.external, n),
            "data-unified": a,
            style: e,
          },
          a
            .split("-")
            .map(function (f) {
              return String.fromCodePoint(parseInt(f, 16));
            })
            .join(""),
        );
      }
      ...
      function R(f) {
        var a = f.emoji,
          ...
          c = f.getEmojiUrl,
          o = f.className,
          l = (0, w.useContext)(j).emojisThatFailedToLoadState[1],
          r = {};
        d && (r.width = r.height = r.fontSize = d + "px");
        var t =
          a ||
          (function (f) {
            if (f) {
              var a;
              return A[f] ? A[f] : A[E[(a = f.split("-")).splice(1, 1)[0]] ? a.join("-") : f];
            }
          })(e);
        if (!t) return null;
        if (void 0 !== t.imgUrl)
          return (0, w.createElement)(I, {
            style: r,
            emojiName: e,
            emojiStyle: u.NATIVE,
            lazyLoad: i,
        ...
        return (0, w.createElement)(
          ...
          null,
          n === u.NATIVE
            ? (0, w.createElement)(U, { unified: e, style: r, className: o })
            : (0, w.createElement)(I, {
                style: r,
                emojiName: t ? x(t)[0] : "",
                emojiStyle: n,
                  ...
                  ? function (f, a) {
                      return (
                        ...
                        (function (f) {
                          switch (f) {
                            case u.TWITTER:
                              return "https://cdn.jsdelivr.net/npm/emoji-datasource-twitter/img/twitter/64/";
                            case u.GOOGLE:
                              return "https://cdn.jsdelivr.net/npm/emoji-datasource-google/img/google/64/";
                            case u.FACEBOOK:
                              return "https://cdn.jsdelivr.net/npm/emoji-datasource-facebook/img/facebook/64/";
                            case u.APPLE:
                            default:
                              return "https://cdn.jsdelivr.net/npm/emoji-datasource-apple/img/apple/64/";
                          }
                        })(a) +
                        f +
                        ".png"
      ...
      n.category,
        ...
        ((m = { flex: { display: "flex" } })[h.ROW] = { flexDirection: "row" }),
        (m[h.COLUMN] = { flexDirection: "column" }),
        (function (f) {
